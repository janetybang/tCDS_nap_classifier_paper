...
id1_plot <- ggplot(id1, aes(time2, AWC)) + 
  ...
  geom_hline(yintercept = 55.5, color = "#007478", size = 2) + 
  geom_hline(yintercept = 49.3, color = "#FAA49E", size = 2) + 
...
id2_plot <- ggplot(id2, aes(time2, AWC)) + 
  ...
  scale_fill_manual(values = c("#007478", "#FAA49E", "white")) +
  geom_hline(yintercept = 20.4, color = "#007478", size = 2) + 
  geom_hline(yintercept = 23.5, color = "#FAA49E", size = 2) + 
  theme(legend.position = "none")
...
id3_plot <- ggplot(id3, aes(time2, AWC)) + 
  ...
  scale_fill_manual(values = c("#007478", "#FAA49E", "white")) +
  geom_hline(yintercept = 99.5, color = "#007478", size = 2) + 
  geom_hline(yintercept = 134, color = "#FAA49E", size = 2) + 
  theme(legend.position = "none")
